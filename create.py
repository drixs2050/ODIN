...
class DBoperator:
    def __init__(self, user, database):
        self.new_conn = psycopg2.connect(user = user, database = database)

    def _get_conn(self):
        return self.new_conn

    def commitQuery(self, query, output):
    ...
    def _deleteTable(table_name, condition):
    	"""
